        ...
        <div className="w-[1193px]">
          ...
          <div className="flex justify-between">
            <div className="w-[234px]">
              ...
              <NavLink className="myAccountDetails" to="/others">
                Others
              </NavLink>
              <NavLink className="myAccountDetails" to="/addresses">
                Addresses
              </NavLink>
              <NavLink className="myAccountDetails" to="/accountDetails">
                Account details
              </NavLink>
              <NavLink className="myAccountDetails" to="/logout">
                Logout
              </NavLink>
            </div>
